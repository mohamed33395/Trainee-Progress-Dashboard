                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <div>
                                    <span
                                        className="text-sm text-muted-foreground">{t.studentReports.languageLevel}:</span>
                                ...
                                <div key={report.id}
                                    ...
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Week {report.week},
                                                    Day {report.day}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        <div>
                                            ...
                                            <span
                                                className="ml-2 text-muted-foreground">{report.topics.join(', ')}</span>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <span
                                                className="ml-2 text-muted-foreground">{report.needsImprovement}</span>
                                        </div>
                                        {report.dailyNotes && (
                                            <div>
